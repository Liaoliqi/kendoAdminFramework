    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                textspan = '<span class="city-picker-span" style="border-radius:5px; padding-left:5px; background:rgba(245,245,245,1);">' +
                    (placeholder ? '<span class="placeholder">' + placeholder + '</span>' : '') +
                    '<span class="title"></span><div class="arrow"></div>' + '</span>',

                dropdown = '<div class="city-picker-dropdown" style="left:10px;top:100%;' +
        ...
        this.$dropdown.on('click', '.province a', function () {
        	$("input[name='hcity']").remove();
        	var data_code = $(this).attr('data-code');
        	var val = $(this).attr('title');
        	var inp = '<input id="hcity" type="hidden" name="hcity" data-id="'+data_code+'" value="'+val+'">';
        	$("#diqu").append(inp);
        })
        this.$dropdown.on('click', '.city a', function () {
        	$("input[name='hproper']").remove();
        	var data_code = $(this).attr('data-code');
        	var val = $(this).attr('title');
        	var inp = '<input id="harea" type="hidden" name="hproper" data-id="'+data_code+'" value="'+val+'">';
        	$("#diqu").append(inp);
        })
        this.$dropdown.on('click', '.district a', function () {
        	$("input[name='harea']").remove();
        	var data_code = $(this).attr('data-code');
        	var val = $(this).attr('title');
        	var inp = '<input id="hcity" type="hidden" name="harea" data-id="'+data_code+'" value="'+val+'">';
        	$("#diqu").append(inp);
        	$("input[name='delivery_area_id']").val(data_code);
        })
